...
function TrustSection() {
  ...
  return (
    <>
      ...
      {/* ── We Care About You — full-bleed photo banner ── */}
          ...
          <Reveal className="relative">
            <div className="relative h-72 lg:h-full min-h-[320px] overflow-hidden">
              <img
                ...
                alt="Dr. Urooj Shibli examining a patient with a stethoscope"
                className="w-full h-full object-cover object-center"
                loading="lazy"
                decoding="async"
              />
              {/* subtle dark gradient on right edge to blend into content */}
          ...
          <div className="bg-gradient-to-br from-slate-900 via-blue-950 to-slate-900 flex items-center px-8 sm:px-12 lg:px-16 py-14 lg:py-0 relative overflow-hidden">
            ...
            >
              ...
              <motion.p variants={fadeUp} className="text-blue-100/80 text-base leading-relaxed mb-8">
                At Shibli Family Medicine, every patient is treated like family. Dr. Shibli takes the time to truly listen, explain, and partner with you on your health journey — not just treat symptoms.
              </motion.p>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-8">
          ...
          <div className="lg:col-span-3 flex flex-col gap-5">
            {/* Embedded map — OpenStreetMap via Nominatim, zero API key needed */}
            <Reveal className="flex-1">
              <div className="rounded-2xl overflow-hidden border border-gray-100 dark:border-gray-800 shadow-sm h-64 lg:h-full min-h-[280px] relative">
                ...
                />
                {/* "Open in Google Maps" chip overlay — bottom right */}
                <a
                  href={`https://maps.google.com/?q=${encodeURIComponent(DOCTOR.address)}`}
                  target="_blank"
                  rel="noopener noreferrer"
                  className="absolute bottom-3 right-3 z-10 flex items-center gap-1.5 bg-white dark:bg-gray-900 text-xs font-semibold text-primary px-3 py-1.5 rounded-full shadow-lg border border-gray-100 dark:border-gray-800 hover:bg-primary hover:text-white transition-colors duration-200"
                >
